...
closestGroundShaking = inputProcessing.extract_closest_ground_shaking(
    locations, groundShakingData)
...
crossCorrMatrix = groundShakingCalculation.calculate_cross_correlation_matrix(
    IMTs, 'cross')
